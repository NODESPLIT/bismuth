namespace Operate {
  ...
  Reference NumberBlock16(Reference left, Reference right) {
  ...
  Reference RangeBlock16(Reference left, Reference right) {
  ...
  Reference ArrayBlock16(Reference left, Reference right) {
  ...
  Reference TableBlock16(Reference left, Reference right) {
